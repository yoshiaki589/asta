...
const TaskType OSEK_Task_ts1 = 1;

extern void TASKNAME( TaskMain )( void );
extern void TASKNAME( OSEK_Task_ts1 )( void );

static __STK_UNIT _stack_TaskMain[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_OSEK_Task_ts1[__TCOUNT_STK_UNIT(512)];
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( TaskMain ), TASKNAME( OSEK_Task_ts1 ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_TaskMain, (__STK_UNIT)_stack_OSEK_Task_ts1, };
...
DeclareTask(OSEK_Task_ts1);
static void _activate_alarm_OSEK_Alarm_task_ts1( void );
static void _activate_alarm_OSEK_Alarm_task_ts1( void )
{ (void)ActivateTask( OSEK_Task_ts1 ); }
...
const TickType alminib_cycle[TNUM_ALARM] = { 400, };
